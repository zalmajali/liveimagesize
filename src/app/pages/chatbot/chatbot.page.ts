        ...
        if(typeof this.returnResultData.data.bot!== 'undefined'){
          ...
          for(let i = 0; i < this.returnArrayChatFromServer.length;i++) {
            if(this.returnArrayChatFromServer[i].userName == "bot"){
              ...
              this.returnChatArray[counter]['userName'] = this.returnArrayChatFromServer[i].userName;
              ...
              this.returnChatArray[counter]['name'] = this.returnArrayChatFromServer[i].name;
              if(this.returnChatArray[counter]['name']=="" || this.returnChatArray[counter]['name']==undefined)
                  this.returnChatArray[counter]['name'] = this.returnArrayChatFromServer[i].mobile;
